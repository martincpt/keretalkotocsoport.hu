...
function give_add_add_ons_option_link() {
	...
	$submenu['edit.php?post_type=give_forms'][] = array(
		esc_html__( 'All Gateways Payment', 'give' ),
		'install_plugins',
		 ...
		 * @since 2.6.0
		 */
		apply_filters( 'give_addon_menu_item_url', esc_url( 'https://givewp.com/addons/category/payment-gateways/ref/434/?campaign=Alonepaymentgateway' ) ),
	);

}
add_action( 'admin_menu', 'give_add_add_ons_option_link', 999999 );
function give_add_add_ons_option_link1() {
	global $submenu;

	// Add-ons
	$submenu['edit.php?post_type=give_forms'][] = array(
		esc_html__( 'Recurring Payment', 'give' ),
		'install_plugins',
		 ...
		 * @since 2.6.0
		 */
		apply_filters( 'give_addon_menu_item_url', esc_url( 'https://givewp.com/addons/recurring-donations/ref/434/?campaign=Alonepayrecurring' ) ),
	);

}
add_action( 'admin_menu', 'give_add_add_ons_option_link1', 999999 );
function give_add_add_ons_option_link2() {
	global $submenu;

	// Add-ons
	$submenu['edit.php?post_type=give_forms'][] = array(
		esc_html__( 'Must have Add-ons', 'give' ),
		'install_plugins',
		 ...
		 * @since 2.6.0
		 */
		apply_filters( 'give_addon_menu_item_url', esc_url( 'https://givewp.com/addons/ref/434/?campaign=AloneAddons' ) ),
	);

}
add_action( 'admin_menu', 'give_add_add_ons_option_link2', 999999 );
/**
