...
function give_admin_addon_menu_inline_scripts() {
	...
	<script>
		( function( $ ) {
			const $addonLink = $( '#menu-posts-give_forms a[href^="https://givewp.com/addons"]' );
	...
	<style>
		#menu-posts-give_forms a[href^="https://givewp.com/addons"].give-highlight {
			color: rgb(43, 194, 83);
			font-weight: 700;
			vertical-align: top;
		...
		#menu-posts-give_forms a[href^="https://givewp.com/addons"].give-highlight span.dashicons {
